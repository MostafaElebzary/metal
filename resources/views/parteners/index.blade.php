...
<div class="app-content content container-fluid">
    <div class="breadcrumb-wrapper col-xs-12">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"> {{trans('admin.parteners')}}
            </li>
...
<div class="row">
    ...
    <div class="col-12">
        <div>
            <a href="{{url('parteners/create')}}  " class="btn btn-info btn-block">{{trans('admin.addparteners')}} </a>
        </div>
                ...
                <table id="datatable" class="table table-striped  table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    <thead style="font-family: Cairo;font-size: 18px;">
                        <tr style='text-align:center; font-family: Cairo;font-size: 18px;'>
                            <th>#</th>
                            <th>{{trans('admin.partenerimage')}}</th> 
                            <th></th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        ...
                        $i = 1;
                        @endphp
                        @foreach($parteners as $user)

                        <tr style='text-align:center'>
                            <td>{{$i}}</td>
                            <td><img src="{{url('uploads/parteners',$user->image)}}" width="75px" height="75px" ></td> 
                            <td> 
                            @php
                                ...
                                <form method="get" id='delete-form-{{ $user->id }}' action="{{url('parteners/'.$user->id.'/delete')}}" style='display: none;'>
                                    {{csrf_field()}}
                                    <!-- {{method_field('delete')}}   -->
                                </form>
