...
<div class="app-content content container-fluid">
    <div class="breadcrumb-wrapper col-xs-12">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"> {{trans('admin.clientsFiles')}}
            </li>
...
<div class="row">
    ...
    <div class="col-12">
        <div>
            <a href="{{url('clientfiles/create/'.$id)}}" class="btn btn-info btn-block">{{trans('admin.addfiles')}} </a>
        </div>
                ...
                <table id="datatable" class="table table-striped  table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    ...
                    <tbody> 
                        ...
                        <tr style='text-align:center'>
                            <td>{{$user->number}}</td>
                            <td><a href="{{url('uploads/clients/'.$user->file) }}" target="_blank">{{$user->name}}</a> </td>
                            <td> 
                            @php
                                ...
                                <!-- <a class='btn btn-raised btn-success btn-sml' href=" {{url('clientfiles/'.$user->id.'/edit')}}"><i class="fa fa-edit"></i></a> -->

                                <form method="get" id='delete-form-{{ $user->id }}' action="{{url('clientfiles/'.$user->id.'/delete')}}" style='display: none;'>
                                    {{csrf_field()}}
                                    <!-- {{method_field('delete')}}   -->
                                </form>
