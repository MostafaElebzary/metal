...
<div class="app-content content container-fluid">
    <div class="breadcrumb-wrapper col-xs-12">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"> {{trans('admin.Services')}}
...
<div class="row">
    ...
    <div class="col-12">
        <div>
            <div>
                <a href="{{url('services/create')}}  " class="btn btn-info btn-block">{{trans('admin.addservice')}} </a>
            </div>
        </div>
                ...
                <table id="datatable" class="table table-striped  table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    <thead style="font-family: Cairo;font-size: 18px;">
                        <tr style='text-align:center; font-family: Cairo;font-size: 18px;'>
                            ...
                            <th>{{trans('admin.serviceimage')}}</th>
                    ...
                    <tbody>
                        ...
                        <tr style='text-align:center'>
                            ...
                            <td>{{$user->title_ar}}</td>
                            <td>{{$user->title_en}}</td>
                            <td><a href="{{url('uploads/services/'.$user->image) }}" target="_blank">
                                    <img src="{{url('uploads/services/'.$user->image) }}" style="width:75px;height:75px;" />
                                </a>
                            </td>
                            <td>
                                @php
                                ...
                                <a class='btn btn-raised btn-success btn-sml' href=" {{url('services/'.$user->id.'/edit')}}"><i class="fa fa-edit"></i></a>

                                <form method="get" id='delete-form-{{ $user->id }}' action="{{url('services/'.$user->id.'/delete')}}" style='display: none;'>
                                    {{csrf_field()}}
                                    <!-- {{method_field('delete')}}   -->
                                </form>
