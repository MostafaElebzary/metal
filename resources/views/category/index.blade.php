...
<div class="row">
    ...
    <div class="col-12">
        <div>
            <a href="{{url('category/create')}}  " class="btn btn-info btn-block">{{trans('admin.addcategory')}} </a>
        </div>
                    ...
                    <tbody>
                        ...
                        <tr style='text-align:center'>
                            ...
                            @php
                                ...
                                <a class='btn btn-raised btn-success btn-sml' href=" {{url('category/'.$user->id.'/edit')}}"><i class="fa fa-edit"></i></a>

                                <form method="get" id='delete-form-{{ $user->id }}' action="{{url('category/'.$user->id.'/delete')}}" style='display: none;'>
                                    {{csrf_field()}}
                                    <!-- {{method_field('delete')}}   -->
                                </form>
