...
<div class="app-content content container-fluid">
    <div class="breadcrumb-wrapper col-xs-12">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"> {{trans('admin.mainservices')}}
                    ...
                    <tbody>
                        ...
                        <tr style='text-align:center'>
                            ...
                            <td>
                                ...
                                <a class='btn btn-raised btn-success btn-sml' href=" {{url('mainservices/'.$user->id.'/edit')}}"><i class="fa fa-edit"></i></a>
