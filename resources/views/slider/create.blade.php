        ...
        <div class="card m-b-20">
            <div class="card-body" style='text-align:right'>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input name="sub_title_ar" class="form-control" type="text" value="{{old('sub_title_ar')}}" placeholder="{{trans('admin.sub_title_ar')}}" required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input name="sub_title_en" class="form-control" type="text" value="{{old('sub_title_en')}}" placeholder="{{trans('admin.sub_title_en')}}" required>
                    </div>
                </div>
