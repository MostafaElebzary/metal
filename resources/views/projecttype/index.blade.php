...
<div class="app-content content container-fluid">
    <div class="breadcrumb-wrapper col-xs-12">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"> {{trans('admin.projectTypeSettings')}}
            </li>
...
<div class="row">
    ...
    <div class="col-12">
        <div>
            <a href="{{url('projecttypes/create')}}  " class="btn btn-info btn-block">{{trans('admin.addprojecttype')}} </a>
        </div>
                    ...
                    <tbody>
                        ...
                        <tr style='text-align:center'>
                            ...
                            @php
                                ...
                                <a class='btn btn-raised btn-success btn-sml' data-placement="top" title=" تعديل " href=" {{url('projecttypes/'.$user->id.'/edit')}}"><i class="fa fa-edit"></i></a>

                                <form method="get" id='delete-form-{{ $user->id }}'  action="{{url('projecttypes/'.$user->id.'/delete')}}" style='display: none;'>
                                    {{csrf_field()}}
                                    <!-- {{method_field('delete')}}   -->
                                </form>
