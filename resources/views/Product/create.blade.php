    ...
    <div class="col-12">
        ...
        <div class="card m-b-20">
            <div class="card-body" style='text-align:right'>
                ...
                {{ Form::open( ['url' => ['works'],'method'=>'post','files'=> true] ) }}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <!-- cat_id -->
                        @if(session('lang')=='en')
                        {{ Form::select('cat_id',App\Category::pluck('name_en','id'),old('cat_id')
            ,["class"=>"form-control dept_id " , 'placeholder'=>'trans("admin.choosecategory")']) }}
            @else
            {{ Form::select('cat_id',App\Category::pluck('name_ar','id'),old('cat_id')
