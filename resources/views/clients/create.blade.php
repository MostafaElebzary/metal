                ...
                <div class="card-body" style='text-align:right'>
                    ...
                    <div class="panel" style='text-align:right'>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="name" class="form-control" type="text" value="{{old('name')}}" placeholder="{{trans('admin.client_name')}}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="id_num" class="form-control" type="number" value="{{old('id_num')}}" placeholder="{{trans('admin.id_num')}}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="check_date" class="form-control" type="date" value="{{old('check_date')}}" placeholder="{{trans('admin.check_date')}}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="total" id="total" class="form-control" type="number" value="{{old('total')}}" placeholder="{{trans('admin.amounts')}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="part_number" class="form-control" type="text" value="{{old('part_number')}}" placeholder="{{trans('admin.part_number')}}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="scheme_number" class="form-control" type="text" value="{{old('scheme_number')}}" placeholder="{{trans('admin.scheme_number')}}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="phone" class="form-control" type="number" value="{{old('phone')}}" placeholder="{{trans('admin.phone')}}" required>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-header" style='text-align:right'> <strong> الدفعات </strong>
                <div class="card-body" style='text-align:right'>
                    <div id="pay_one" class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <input name="rows[0][name]" class="form-control" type="text" value="الدفعة الاولى" readonly>

                        </div>
                        <div class="col-sm-3">
                            <input name="rows[0][amount]" id="amount_one" class="form-control" type="number" value="" placeholder="{{trans('admin.amount')}}">
                        ...
                        <div class="col-sm-2">
                            <button type="button" id="plus_one" class="btn btn-secondary waves-effect"><i class="fa fa-plus"></i></button>
                    ...
                    <div id="pay_two" class="form-group row" style='display: none;'>
                        ...
                        <div class="col-sm-3">
                            <input name="rows[1][name]" class="form-control" type="text" value="الدفعة الثانيه" readonly>

                        </div>
                        <div class="col-sm-3">
                            <input name="rows[1][amount]" id="amount_two" class="form-control" type="number" value="" placeholder="{{trans('admin.amount')}}">
                        ...
                        <div class="col-sm-2">
                            <button type="button" id="plus_two" class="btn btn-secondary waves-effect"><i class="fa fa-plus"></i></button>
                            <button type="button" id="del_two" class="btn btn-danger waves-effect"><i class="fa fa-trash"></i></button>
                    ...
                    <div id="pay_three" class="form-group row" style='display: none;'>
                        ...
                        <div class="col-sm-3">
                            <input name="rows[2][name]" class="form-control" type="text" value="الدفعة الثالثه" readonly>

                        </div>
                        <div class="col-sm-3">
                            <input name="rows[2][amount]" id="amount_three" class="form-control" type="number" value="" placeholder="{{trans('admin.amount')}}">
                        ...
                        <div class="col-sm-2">
                            <button type="button" id="plus_three" class="btn btn-secondary waves-effect"><i class="fa fa-plus"></i></button>
                            <button type="button" id="del_three" class="btn btn-danger waves-effect"><i class="fa fa-trash"></i></button>
                    ...
                    <div id="pay_four" class="form-group row" style='display: none;'>
                        ...
                        <div class="col-sm-3">
                            <input name="rows[3][name]" class="form-control" type="text" value="الدفعة الرابعه" readonly>

                        </div>
                        <div class="col-sm-3">
                            <input name="rows[3][amount]" id="amount_four" class="form-control" type="number" value="" placeholder="{{trans('admin.amount')}}">
                        ...
                        <div class="col-sm-2">
                            <button type="button" id="plus_four" class="btn btn-secondary waves-effect"><i class="fa fa-plus"></i></button>
                            <button type="button" id="del_four" class="btn btn-danger waves-effect"><i class="fa fa-trash"></i></button>
                    ...
                    <div id="pay_five" class="form-group row" style='display: none;'>
                        ...
                        <div class="col-sm-3">
                            <input name="rows[4][name]" class="form-control" type="text" value="الدفعة الخامسة" readonly>

                        </div>
                        <div class="col-sm-3">
                            <input name="rows[4][amount]" id="amount_five" class="form-control" type="number" value="" placeholder="{{trans('admin.amount')}}">
                        ...
                        <div class="col-sm-2">
                            ...
                            <button type="button" id="del_five" class="btn btn-danger waves-effect"><i class="fa fa-trash"></i></button>
            ...
            <div class="card-header" style='text-align:right'> <strong> المرفقات </strong>
                <div class="card-body" style='text-align:right'>
                    <div id="file_one" class="form-group row">
                        <!-- <label for="example-url-input" class="col-sm-1 col-form-label">{{trans('admin.installments')}}</label> -->
                        <div class="col-sm-2">
                            <input name="atts[0][file_number]" class="form-control" readonly type="number" value="1">

                        </div>
                        <div class="col-sm-4">
                            <input name="atts[0][file_name]" class="form-control" type="text" placeholder="{{trans('admin.file')}}">
                        ...
                        <div class="col-sm-2">
                            <button type="button" id="fileplus_one" class="btn btn-secondary waves-effect"><i class="fa fa-plus"></i></button>
                            <!-- <button type="button" id="del_one" class="btn btn-danger waves-effect" ><i class="fa fa-trash"></i></button> -->
                        </div>
                    </div>
                    <div id="file_two" style='display: none;' class="form-group row">
                        <!-- <label for="example-url-input" class="col-sm-1 col-form-label">{{trans('admin.installments')}}</label> -->
                        <div class="col-sm-2">
                            <input name="atts[1][file_number]" class="form-control" readonly type="number" value="2">

                        </div>
                        <div class="col-sm-4">
                            <input name="atts[1][file_name]" id="filename_two" class="form-control" type="text" placeholder="{{trans('admin.file')}}">
                        ...
                        <div class="col-sm-2">
                            <button type="button" id="fileplus_two" class="btn btn-secondary waves-effect"><i class="fa fa-plus"></i></button>
                            <button type="button" id="filedel_two" class="btn btn-danger waves-effect"><i class="fa fa-trash"></i></button>
                        </div>
                    </div>
                    ...
                    <div id="file_three" style='display: none;' class="form-group row">
                        <!-- <label for="example-url-input" class="col-sm-1 col-form-label">{{trans('admin.installments')}}</label> -->
                        <div class="col-sm-2">
                            <input name="atts[2][file_number]" class="form-control" readonly type="number" value="3">

                        </div>
                        <div class="col-sm-4">
                            <input name="atts[2][file_name]" id="filename_three" class="form-control" type="text" placeholder="{{trans('admin.file')}}">
                        ...
                        <div class="col-sm-2">
                            <button type="button" id="fileplus_three" class="btn btn-secondary waves-effect"><i class="fa fa-plus"></i></button>
                            <button type="button" id="filedel_three" class="btn btn-danger waves-effect"><i class="fa fa-trash"></i></button>
                        </div>
                    </div>
                    ...
                    <div id="file_four" style='display: none;' class="form-group row">
                        <!-- <label for="example-url-input" class="col-sm-1 col-form-label">{{trans('admin.installments')}}</label> -->
                        <div class="col-sm-2">
                            <input name="atts[3][file_number]" class="form-control" readonly type="number" value="4">

                        </div>
                        <div class="col-sm-4">
                            <input name="atts[3][file_name]" id="filename_four" class="form-control" type="text" placeholder="{{trans('admin.file')}}">
                        ...
                        <div class="col-sm-2">
                            <button type="button" id="fileplus_four" class="btn btn-secondary waves-effect"><i class="fa fa-plus"></i></button>
                            <button type="button" id="filedel_four" class="btn btn-danger waves-effect"><i class="fa fa-trash"></i></button>
                        </div>
                    </div>
                    ...
                    <div id="file_five" style='display: none;' class="form-group row">
                        <!-- <label for="example-url-input" class="col-sm-1 col-form-label">{{trans('admin.installments')}}</label> -->
                        <div class="col-sm-2">
                            <input name="atts[4][file_number]" class="form-control" readonly type="number" value="5">

                        </div>
                        <div class="col-sm-4">
                            <input name="atts[4][file_name]" id="filename_five" class="form-control" type="text" placeholder="{{trans('admin.file')}}">
                        ...
                        <div class="col-sm-2">
                            ...
                            <button type="button" id="filedel_five" class="btn btn-danger waves-effect"><i class="fa fa-trash"></i></button>
                        </div>
                    </div>
